...
examples = [
    ...
    "http://a.example/AZazÀÖØöø˿ͰͽͿ\u1fff\u200c\u200d⁰\u218fⰀ\u2fef、\ud7ff﨎﷏ﷰ\uffef",
    "http://a/?\ue000",
    "http://example.123./aaa/bbb#ccc",
    "http://example.comhttp://example.com#toto",
    "http://example.com/",
...
def write_corpus(name, examples):
    corpus_dir = Path("corpus") / name
...
write_corpus("parse", examples)
write_corpus("resolve", example_pairs)
write_corpus("relativize", example_pairs)
